<template>
	...
	<div class="col-3 fade-in one">
        <img class="logo" src="../../public/logo1.png" alt="" />
        <h2 class="h2">جريدة قراء</h2>
		<h3 class="fade-in two"> ....... قريبا </h3>
		<div class="social fade-in three">
            ...
            <router-link class="back-home" to="/">الصفحه الرئيسيه</router-link>
		</div>
	</div>
</div>
